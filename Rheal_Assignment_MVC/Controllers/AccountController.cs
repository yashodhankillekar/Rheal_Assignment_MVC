...
namespace Rheal_Assignment_MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        RhealAssignmentDBContext rhealDbContext;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string Role)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //create new entry in Students or Trainers

                    if (Role == "Student")
                    {
                        return RedirectToAction("makeEntry", "Student", new { user_id = user.Id });
                    }
                    else if (Role == "Trainer")
                    {
                        return RedirectToAction("makeEntry", "Trainer", new { user_id = user.Id });
                    }
